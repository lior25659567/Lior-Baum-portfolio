...
export const useHeatField = ({ fade = 1, invertFade = false, useBand = true, speed = 1 } = {}) => {
  ...
  useEffect(() => {
    ...
    const field = mountHeatField(canvasRef.current, { fade, invertFade, speed, bandEl: useBand ? bandRef.current : null });
